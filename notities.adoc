...
. De makellar heeft ons heel goed *geholpen*.
...
. Mijn vriend is gisteren bijn zijn ouders *gebleven*.
...
. Ben je met de cursus Nederlands gestopt? Ja, ik ben met de cursus Nederlands verder gegaan. (?)
. Wat heb je in een cafe in het Nederlands besteld? I heb een latte besteld.
. Heb je een gemeubileerde kamer gehuurd? Nee, ik heb een gemeubileerde kamer niet gehuurd.
. Waar heb je vorig jaar gewerkt / gestudeerd? Ik heb vorig jaar gewerkt Thuis.
. Wanneer heb je naar de dialoog van hoofdstuk 9 geluisterd? Ik heb laste weekend naar de dialoog van hoofdstuk 9 geluisterd.
...
. Wat heb je geruild? Ik heb nix geruild.
...
. Wat heb je vandaag gedronken? Ik heb vandaag twee cupjes koffie gedronken.
. Wat heb je gisteren gegeten? Ik heb gisteren Chinese (uitspraak) hotpot gegeten.
. Wie heb je vorige week een e-mail geschreven? Ik ben vorige week een e-mail tot mijn ouders geschreven. (Klopt of niet met "ben")
...
. Wanneer ben je naar Nederland gekomen? Ik ben in 2009 naar Nederland gekomen.  (Ik kom hier in 2009 of Ik kom in 2009 hier.)
