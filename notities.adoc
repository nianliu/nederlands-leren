...
[%header,cols=6]
|===
| subject   | object    | possessief pronomen | werkwoorden | zijn  | hebben
| ik        | mij / me  | mijn                | de stam     | ben   | heb
| jij / je  | jou / je  | jouw / je           | stam + t    | bent  | hebt
| u         | u         | uw                  | stam + t    | bent  | hebt / heeft
| hij       | hem       | zijn                | stam + t    | is    | heeft
| zij / ze  | haar      | haar                | stam + t    | is    | heeft
| wij / we  | ons       | onze / ons          | infinitief  | zijn  | hebben
| jullie    | jullie    | jullie              | infinitief  | zijn  | hebben
| zij / ze  | hen / ze  | hun                 | infinitief  | zijn  | hebben
|===
